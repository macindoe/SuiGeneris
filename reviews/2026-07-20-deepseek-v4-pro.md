# Cross-family adversarial review — DeepSeek V4 Pro

**Routed model (authoritative):** OpenRouter id `deepseek/deepseek-v4-pro`
**Self-identification in the response:** "Gemini 2.5 Pro (Google DeepMind)", review self-dated 2026-07-21 — **does not match the routed model; date off by one day.**
