# Cross-family adversarial review — Zhipu GLM 5.2

**Routed model (authoritative):** OpenRouter id `z-ai/glm-5.2`
**Self-identification in the response:** "Google Gemini (1.5 Pro / Gemini Advanced)" — **does not match the routed model.**
